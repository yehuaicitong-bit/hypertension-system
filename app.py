...
""", unsafe_allow_html=True)
    ...
    province_data = [
        ["西藏",40.7],["海南",16.7],
        ["北京",30.4],["天津",30.4],["河北",30.4],["山西",30.4],["内蒙古",30.4],
        ["辽宁",29.2],["吉林",29.2],["黑龙江",29.2],
        ["广东",20.7],["广西",20.7],
        ["上海",31.6],["江苏",31.6],["浙江",31.6],["安徽",31.6],["福建",31.6],
        ["江西",31.6],["山东",31.6],["河南",31.6],["湖北",31.6],["湖南",31.6],
        ["重庆",31.6],["四川",31.6],["贵州",31.6],["云南",31.6],
        ["陕西",31.6],["甘肃",31.6],["青海",31.6],["宁夏",31.6],["新疆",31.6]
    ]
    ...
    map_chart = (
        ...
        .set_global_opts(
            title_opts=opts.TitleOpts(title="中国高血压患病率空间分布", subtitle="数据来源：权威文献"),
            visualmap_opts=opts.VisualMapOpts(
                is_piecewise=True,
                pieces=[
                    {"min": 15, "max": 20, "label": "15-20%", "color": "#e0f7fa"},
                    {"min": 20, "max": 25, "label": "20-25%", "color": "#81c9fa"},
                    {"min": 25, "max": 30, "label": "25-30%", "color": "#ffeb3b"},
                    {"min": 30, "max": 35, "label": "30-35%", "color": "#ff5722"},
                    {"min": 35, "max": 45, "label": "35-45%", "color": "#d32f2f"}
                ],
                pos_left="left",
                pos_bottom="10%"
            )
